...
import './translationdisplayer.css'

const TranslationDisplayer = () => {
  ...
  return (
    <>
      <article id='translation-display'>
        <form onSubmit={handleSubmit}>
          ...
          <button className='btn' type='button' onClick={() => setResult([])}>Clear All</button>
        </form>
      </article>
    <br></br>
...
export default TranslationDisplayer